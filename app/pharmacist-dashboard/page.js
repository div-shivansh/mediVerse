...
import { ArrowUp, CalendarPlus, CheckCheck, CheckCircle, Clock4, Edit, Eye, Flame, HeartPulse, Hourglass, IndianRupee, LogOut, Plus, Users, X } from 'lucide-react';
                                        ...
                                        <tr key={patient.id} className="hover:bg-blue-50 transition-colors duration-200">
                                            ...
                                            <td className="px-6 py-5">
                                                <div className="flex gap-3">
                                                    <button className="w-8 h-8 rounded-lg bg-blue-100 cursor-pointer text-blue-600 hover:bg-blue-200 transition-all flex items-center justify-center" title="View Details">
                                                        <Eye />
                                                    </button>
                                                    <button className="w-8 h-8 rounded-lg bg-purple-100 cursor-pointer text-purple-600 hover:bg-purple-200 transition-all flex items-center justify-center" title="Edit">
                                                        <Edit />
                                                    </button>
                                                </div>
                                            </td>
                ...
                <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center top-20 z-50 p-4">
                    <div className="bg-white rounded-3xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                        ...
                        <form onSubmit={handleAddPatient} className="p-8">
                            ...
                            <button
                                type="submit"
                                className="w-full py-4 bg-gradient-to-r flex items-center justify-center gap-3 cursor-pointer from-blue-600 to-teal-500 text-white rounded-xl font-bold text-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                            >
                                <CalendarPlus />
                                Book Appointment
                            </button>
